...
2. login to [artifactory.eccenca.com](https://artifactory.eccenca.com/elds-release/) and download artifact zip files into the `artifacts` folder - see [artifacts/README.md](artifacts/README.md) for details
